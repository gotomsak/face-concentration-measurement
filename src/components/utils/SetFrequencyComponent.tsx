              ...
              onInputChange={(e, value) => {
                frequencys.max_frequency.forEach((element: any) => {
                  if (element.date === value) {
                    ...
                    dispatch({
                      type: "maxBlinkSet",
                      maxBlink: element["max_frequency_data"].max_blink,
                    });
                    dispatch({
                      type: "maxFaceMoveSet",
                      maxFaceMove: element["max_frequency_data"].max_face_move,
                    });
                  }
                });
              ...
              onInputChange={(e, value) => {
                frequencys.min_frequency.forEach((element: any) => {
                  if (element.date === value) {
                    ...
                    console.log(element["min_frequency_data"].min_blink);
                    dispatch({
                      type: "minFreqIDSet",
                    ...
                    dispatch({
                      type: "minBlinkSet",
                      minBlink: element["min_frequency_data"].min_blink,
                    });
                    dispatch({
                      type: "minFaceMoveSet",
                      minFaceMove: element["min_frequency_data"].min_face_move,
                    });
                  }
                });
