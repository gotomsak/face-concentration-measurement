...
const SelectQuestionAnalysisComponent: React.FC<{select_question_id: any}>=(props)=>{
    ...
    useEffect(() => {
        ...
        adminGetSelectAnswerResultSection(props.select_question_id)
            .then((res:any)=>{
                console.log(res.data)
                setgSARS({select_answer_result_section: res.data.select_answer_result_section})
            })
    }, [])
    ...
    return (
        ...
        <div>
            <ConcToCorrectViewComponent ConcToCorrectData={viewData}>
